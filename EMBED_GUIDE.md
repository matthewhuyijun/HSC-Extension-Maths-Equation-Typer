...
<div class="section-card card" style="margin-top: 20px;">
    <div class="card-body body stack">
        ...
        <div class="latexlive-embed-container">
            <iframe id="latexLiveFrame" src="../LaTeXLive-main/html/index.html" title="LaTeXLive Editor"></iframe>
        </div>
    </div>
</div>
```
...
**For `index.html`:**
```javascript
src="../LaTeXLive-main/html/index.html"
```
...
│   ├── index.html ← Uses path: ../LaTeXLive-main/html/index.html
│   ├── test-embedded-latexlive.html
│   └── untitled folder/
│       └── working final.html ← Uses path: ../../LaTeXLive-main/html/index.html
└── LaTeXLive-main/
    └── html/
        └── index.html ← The LaTeXLive editor
```

Both projects **must** be in the same parent directory (`/Users/matthew/Desktop/`) for the relative paths to work.
...
❌ If you see errors:
- Check that LaTeXLive-main folder exists
...
ls -la /Users/matthew/Desktop/LaTeXLive-main/html/index.html
```
...
- Absolute: `file:///Users/matthew/Desktop/LaTeXLive-main/html/index.html`
...
- **LaTeXLive docs**: `../LaTeXLive-main/` (in LaTeXLive folder)
